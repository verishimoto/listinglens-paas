          ...
          child: InkWell(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                borderRadius: const BorderRadius.horizontal(left: Radius.circular(30)),
                border: isActive 
                  ? const Border(left: BorderSide(color: AppColors.signalColor, width: 4))
                  : null, 
              ),
              child: Row(
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: passed ? null : Border.all(color: AppColors.textMain.withOpacity(0.3), width: 2),
                    ),
                    child: Center(
                      child: passed
                  ...
                  Text(
                    ...
                    style: TextStyle(
                      ...
                      shadows: isActive ? [
                        Shadow(color: Colors.white.withOpacity(0.6), blurRadius: 15)
                      ] : null,
                    ),
                  ),
                ],
...
class _MeniscusPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    topCurve.quadraticBezierTo(size.width * 0.5, 24, size.width, 0); // Ease out?
    ...
    canvas.drawPath(
      Path()
        ...
        ..arcToPoint(Offset(0, size.height - 24), radius: const Radius.circular(24), clockwise: true) // Clockwise? No.
    ...
    canvas.drawPath(
      Path()
        ...
        ..arcToPoint(Offset(size.width, size.height - 24), radius: const Radius.circular(24), clockwise: false)
        ..close(),
      paint,
    );
  }
